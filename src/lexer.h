...
enum class TokenType {
    ...
    EXPLAIN_CONTEXT,    // EXPLAIN CURRENT CONTEXT VIEW PLAN
    SHOW_TABS,          // LIST CONTEXT TOPIC TABS
    SHOW_CONTEXT_SCHEMAS, // LIST CONTEXT SCHEMA REGISTRY
    SHOW_CONTEXT_OBJECTS, // LIST CONTEXT FABRIC OBJECTS
    ALIAS_TAB,          // ADD CONTEXT TAB ALIAS
    MERGE_TABS,         // MERGE CONTEXT TABS
