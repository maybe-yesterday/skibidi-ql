...
const std::unordered_map<std::string, TokenType> Lexer::KEYWORDS = {
    ...
    {"manifest-dataset", TokenType::MANIFEST_DATASET},
    {"manifest-snapshot", TokenType::MANIFEST_SNAPSHOT},
    {"export-torch",    TokenType::EXPORT_TORCH},
    {"ship-torch",      TokenType::SHIP_TORCH},
    {"explain-batch",   TokenType::EXPLAIN_BATCH},
    {"spill-batch",     TokenType::SPILL_BATCH},
    {"with-seed",       TokenType::WITH_SEED},
    {"batch-size",      TokenType::BATCH_SIZE},
    {"world-size",      TokenType::WORLD_SIZE},
    {"max-len",         TokenType::MAX_LEN},
    ...
    {"alias-tab",       TokenType::ALIAS_TAB},
    {"merge-tabs",      TokenType::MERGE_TABS},
    {"token-budget",    TokenType::TOKEN_BUDGET},
    {"vibe-tab",        TokenType::VIBE_TAB},
    ...
    {"skip",            TokenType::SKIP},
    {"plus",            TokenType::PLUS},
    // Plain SQL aliases accepted for TensorQL-style examples.
    {"select",          TokenType::SLAY},
    {"SELECT",          TokenType::SLAY},
    {"from",            TokenType::NO_CAP},
    {"FROM",            TokenType::NO_CAP},
    {"where",           TokenType::ONLY_IF},
    {"WHERE",           TokenType::ONLY_IF},
    {"as",              TokenType::LOWKEY},
    {"AS",              TokenType::LOWKEY},
    {"and",             TokenType::PLUS},
    ...
    {"or",              TokenType::OR_NAH},
    {"OR",              TokenType::OR_NAH},
    {"not",             TokenType::NO_CAP_NOT},
    {"NOT",             TokenType::NO_CAP_NOT},
    {"null",            TokenType::GHOSTED},
    {"NULL",            TokenType::GHOSTED},
    {"distinct",        TokenType::UNIQUE_FR},
    {"DISTINCT",        TokenType::UNIQUE_FR},
    {"limit",           TokenType::CAP_AT},
    {"LIMIT",           TokenType::CAP_AT},
    {"offset",          TokenType::SKIP},
    {"OFFSET",          TokenType::SKIP},
    {"asc",             TokenType::UP_ONLY},
    {"ASC",             TokenType::UP_ONLY},
    {"desc",            TokenType::DOWN_BAD},
    {"DESC",            TokenType::DOWN_BAD},
